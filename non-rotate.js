...
function preload() {
  ...
  tileImages[0] = loadImage(`${path}/cross.png`);
  tileImages[0] = loadImage(`${path}/down.png`);
  tileImages[0] = loadImage(`${path}/left.png`);
  tileImages[0] = loadImage(`${path}/right.png`);
  tileImages[0] = loadImage(`${path}/up.png`);
  // for (let i = 0; i < 13; i++) {
